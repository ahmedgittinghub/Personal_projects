...
def name_insert(name):
    while name == '0':
         name = input("Please insert the correct input : ")
    return name
...
def postcode_function(something):
    while something == '0':
        ...
        emptyy = ''
        while postcode1 == 0:
            postcode1 = input('please insert the first part of your postcode ').capitalize().strip()
            if postcode1.strip() != '':
                    if len(postcode1.replace(' ','')) < 2 or len(postcode1.replace(' ','')) > 4:
                        print('please input the correct characters')
                        postcode1 = 0
                    else:
                        print('thankyou for your input')
        while postcode2 == 0:
            postcode2 = input('please insert the second part of your postcode ').capitalize().strip()
            if postcode2 != '':
                if len(postcode2) != 3:
                    print('please input a potcode of 3 character')
                    postcode2 = 0
